...
nohup env \
    ...
    RTK_POSITION_HOLD_ENABLED="${RTK_POSITION_HOLD_ENABLED:-1}" \
    RTK_POSITION_HOLD_SPEED_THRESHOLD_MPS="${RTK_POSITION_HOLD_SPEED_THRESHOLD_MPS:-0.03}" \
    RTK_POSITION_HOLD_ODOM_TIMEOUT_SEC="${RTK_POSITION_HOLD_ODOM_TIMEOUT_SEC:-2.0}" \
